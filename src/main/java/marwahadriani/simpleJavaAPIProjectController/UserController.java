...
import marwahadriani.simplejavaAPIService.UserService;
...
public class UserController {
    ...
    public ResponseWeb<String> register(@RequestBody UserRegisterRequest request){
        userService.register(request);
        return ResponseWeb.<String>builder().data("oke").build();
    }
